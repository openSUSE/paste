...
<form action="<?=base_url()?>index.php/create" method="post" accept-charset="utf-8">
	<p id="data">
		<label>Title: </label><input type="text" name="title" value="" id="info" />
		<label>Name: </label><input type="text" name="name" value="" id="info" />
		<label>Private:</label><input type="checkbox" name="private" value="1" id="private">
	</p>
	<textarea name="code" id="newpaste"></textarea>
	
	<p>
		<input type="submit" value="Paste!" id="sub"> 
		
							<select name="lang" id="lang" class="singline">
