				...
				<div class="container">
					...
					<div class="links">
						<ul>
							...
							<li <?php if($l == "lists" || $l == "view"){ echo 'class="active"'; }?><?=anchor("lists", "Recent", array("title" => "Recent Pastes"))?></li>
							<li <?php if($l == "about"){ echo 'class="active"'; }?>><?=anchor("about", "About", array("title" => "About Paste.mycodenow.com"))?></li>
						</ul>
					</div>
				</div>
			</div>
